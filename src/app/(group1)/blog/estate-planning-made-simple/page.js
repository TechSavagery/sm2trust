...
import blog_estate_planning from "@/assets/images/blog-estate-planning-made-simple.jpeg";
    ...
    <>
      <section className="">
        <div
          ...
          style={{
            backgroundImage: `url(${blog_estate_planning.src})`,
        ...
        >
          <div className="container ">
            ...
            <p className="mt-14 text-secondary-foreground flex sm:gap-[9px] gap-[1px]">
              {" "}
              <span>December 1, 2025</span> / <span>Estate Planning</span> /{" "}
