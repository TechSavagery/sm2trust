...
const bannerBottomContent = [
  ...
  },
  {
    id: 2,
    banner_img: hero_6,
    title: "Conservator-of-the-Person Services",
  },
  {
    id: 3,
    banner_img: hero_7,
    title: "Special Needs Trusts and Guardianship Services",
  },
  {
    id: 4,
    banner_img: hero_5,
    title: "Conservator-of-the-Estate Services",
  },
  {
    id: 5,
    banner_img: hero_6,
...
const BannerTwo = () => {
  ...
  const pagination = {
    ...
    renderBullet: function (index, className) {
      return `<span class='${className} text-white translate-y-16 opacity-0 absolute h-0 leading-[90%] [font-size:_clamp(60px,10vw,50px)] font-extrabold lg:text-right'>${bannerData[index].title}</span>`;
    },
  };
  return (
