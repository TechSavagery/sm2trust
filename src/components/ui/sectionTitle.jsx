      ...
      <div className="container relative">
        <div
          className={cn(
            ...
            {
              "xl:-mt-16 -mt-8": !sectionName, // Adjust spacing if sectionName is not present
            }
          )}
        >
          <h2
          ...
          <div className="flex md:flex-row flex-col justify-between md:items-center">
            <h5
              className={cn(
                `text-primary-foreground lg:text-[35px] sm:text-3xl text-2xl font-semibold mt-4 max-w-[800px] md:mb-0 mb-7 !leading-160 ${text_muted}`
              )}
            >
              {sectionDesc}
            </h5>
